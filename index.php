...
<body>
      ...
      <section id="intro">
            ...
            <pre class="intro-pre">
                My Name is Giorgi Dzigoshvili I am a Web Developer in age 14 
      ...
      <section class="counters">
            <div class="container">
                  ...
                  <div class="counter-holder">
                        ...
                        <div class="counter" id="counter-holder-counter-3" data-target="143">0</div>
      ...
      <section id="projects">
            ...
            <div id="projects-container">
                  ...
                  <div class="projects-container-box" style="margin-left: 350px">
      ...
      <section id="project-offer-section">
            <div class="project-offer-section-text">
                  <h1 class="project-offer-section-text-h1" id="typed2">Have a project on your mind</h1>

                  <p class="project-offer-section-text-p" id="typed-p">A small river named Duden flows by their place
                        and supplies it
                        with the necessary<br>
                        regelialia. It is a paradisematic country, in which roasted parts of sentences fly.</p>
